        ...
        if (!TextUtils.isEmpty(login) && !TextUtils.isEmpty(password)) {
            ...
            QBAuth.createSession(login, password, new QBEntityCallbackImpl<QBSession>() {
                    ...
                    if (chatService.isLoggedIn()) {
                        ...
                        chatService.login(user, new QBEntityCallbackImpl<QBUser>() {
                            ...
                            public void onError(List errors) {
                                ...
                                Toast.makeText(ChatConnectionService.this, "Error when login", Toast.LENGTH_SHORT).show();
                ...
                public void onError(List<String> errors) {
                    ...
                    sendResultToActivity(false);
                    Toast.makeText(ChatConnectionService.this, "Error when login, check test users login and password", Toast.LENGTH_SHORT).show();
                }
            });
        } else {
            sendResultToActivity(false);
            stopForeground(true);
            stopService(new Intent(getApplicationContext(), ChatConnectionService.class));
        }
    }
    ...
    private void sendResultToActivity (boolean isSuccess){
        ...
        if (startServiceVariant == Consts.LOGIN) {
            try {
                ...
                pendingIntent.send(ChatConnectionService.this, Consts.LOGIN_RESULT_CODE, intent);
